...
# Test Code Generation test with GPT OSS 20B
...
data = {
    ...
    'environment_name': 'Test_Calculator_GPT_OSS_20B',
    'output_format': 'JSON',
    'session_id': 'test-gpt-oss-session-001'
}
...
print('Testing Test Code Generation with GPT OSS 20B...')
print(f'Request data: {json.dumps(data, indent=2)}')

try:
    response = requests.post(url, data=data, files=files, timeout=600)  # 10 minutes timeout
