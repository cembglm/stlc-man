 ...
 * 
 * Pipeline visualization is now handled by PipelineConfigItem components
 * rendered in TabPanel.jsx. This file is kept for reference but is not
 * imported or rendered anywhere in the application.
 * 
