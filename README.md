...
**STLC** aşağıdaki modülleri içerir:

1. **Code Review** - Kod kalitesi analizi ve öneriler
2. **Requirement Analysis** - Gereksinim dokümanları analizi  
3. **Test Planning** - Test planı oluşturma ve zamanlama
4. **Test Scenario Generation** - Kapsamlı test senaryoları üretimi
5. **Test Case Optimization** - Test case'lerin optimizasyonu
6. **Environment Setup** - Test ortamı kurulum rehberi
7. **Test Execution** - Test yürütme (geliştirilecek)
8. **Test Reporting** - Test raporlama (geliştirilecek)
...
### 📝 Modüller ve Prompt'ları
| Modül | Açıklama | Otomatik Prompt |
|-------|----------|-----------------|
| Code Review | Kod kalitesi analizi | ✅ ISTQB standartları |
| Requirement Analysis | Gereksinim uyumluluk kontrolü | ✅ Kapsamlı analiz |
| Test Planning | Gantt chart uyumlu planlama | ✅ Tarih hesaplamalı |
| Test Scenario Generation | Test senaryoları üretimi | ✅ ISTQB sertifikalı |
| Environment Setup | Kurulum rehberi | ✅ JSON formatında |

### 🎯 Akıllı Özellikler
- **Token limit yönetimi** - Büyük dosyalar için otomatik bölme
- **Model desteği** - LM Studio, OpenAI, Ollama
- **Session yönetimi** - Tüm işlemler tracklenír
- **Dosya upload** - Çoklu dosya desteği
- **Pipeline execution** - Adımları zincirleyebilme
